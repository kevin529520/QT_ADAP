...
# 定义预测函数
def weldPosPredict(image, model_path, output_image_path):
    # 加载模型
...
if __name__ == "__main__":
    ...
    # 进行预测
    weld_pos, circle_center, circle_radius = weldPosPredict(image_path, model_path, output_image_path)
